...
class InverseKinematics(models.Model):
    ...
    theta1 = models.FloatField(null=True, blank=True, default=0)
    theta2 = models.FloatField(null=True, blank=True, default=0)
    theta3 = models.FloatField(null=True, blank=True, default=0)
    theta4 = models.FloatField(null=True, blank=True, default=0)
    theta11 = models.FloatField(null=True, blank=True, default=0)
    theta22 = models.FloatField(null=True, blank=True, default=0)
    theta33 = models.FloatField(null=True, blank=True, default=0)
    theta44 = models.FloatField(null=True, blank=True, default=0)
